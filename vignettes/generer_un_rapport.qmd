...
colnames(donnees_elus) <- make.names(colnames(donnees_elus))

str(donnees_elus)
names(donnees_elus)

# Création du dataframe de la commune de Nantes
df_Nantes <- donnees_elus[donnees_elus$Libellé.de.la.commune == "Nantes",]

# Création du dataframe du département de la Loire-Atlantique
df_Loire_Atlantique <- donnees_elus[donnees_elus$Libellé.du.département == "Loire-Atlantique",]
